...
if (isset($ten) && isset($mail) && isset($dt) && isset($dc)) {
    ...
    // Phải chỉnh sửa lại
    $mailer->Username = "your_email@gmail.com"; // GMAIL username
    $mailer->Password = "your_password"; // GMAIL password
    $mailer->AddAddress($mail, $ten); //email người nhận
    $mailer->AddCC("admin_email@gmail.com", "Admin Vietpro Shop"); // gửi thêm một email cho Admin
    // Chuẩn bị gửi thư nào
    $mailer->FromName = 'Vietpro Shop'; // tên người gửi
    $mailer->From = 'your_email@gmail.com'; // mail người gửi
